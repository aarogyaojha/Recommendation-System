...
def main():
    ...
    api_url_get = "http://soulfulswings.publicvm.com:5000/api/get-responses"  # Fetch user responses
    api_url_post = "http://soulfulswings.publicvm.com:5000/api/data"           # Send recommendations
